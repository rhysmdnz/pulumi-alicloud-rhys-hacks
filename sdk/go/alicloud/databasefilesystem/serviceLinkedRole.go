...
func NewServiceLinkedRole(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("alicloud:databasefilesystem/serviceLinkedRole:ServiceLinkedRole", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceLinkedRole(ctx *pulumi.Context,
	...
	var resource ServiceLinkedRole
	err := ctx.ReadResource("alicloud:databasefilesystem/serviceLinkedRole:ServiceLinkedRole", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
