...
func (o GetTriggersTriggerOutput) UrlInternet() pulumi.StringOutput {
	return o.ApplyT(func(v GetTriggersTrigger) string { return v.UrlInternet }).(pulumi.StringOutput)
}

func (o GetTriggersTriggerOutput) UrlIntranet() pulumi.StringOutput {
	return o.ApplyT(func(v GetTriggersTrigger) string { return v.UrlIntranet }).(pulumi.StringOutput)
}
