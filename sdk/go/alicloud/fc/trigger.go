...
func (o TriggerOutput) UrlInternet() pulumi.StringOutput {
	return o.ApplyT(func(v *Trigger) pulumi.StringOutput { return v.UrlInternet }).(pulumi.StringOutput)
}

func (o TriggerOutput) UrlIntranet() pulumi.StringOutput {
	return o.ApplyT(func(v *Trigger) pulumi.StringOutput { return v.UrlIntranet }).(pulumi.StringOutput)
}
