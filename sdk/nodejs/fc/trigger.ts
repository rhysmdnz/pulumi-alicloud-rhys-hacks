...
export class Trigger extends pulumi.CustomResource {
    ...
    public /*out*/ readonly urlInternet!: pulumi.Output<string>;
    public /*out*/ readonly urlIntranet!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: TriggerArgs | TriggerState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["urlInternet"] = state ? state.urlInternet : undefined;
            resourceInputs["urlIntranet"] = state ? state.urlIntranet : undefined;
        } else {
            ...
            resourceInputs["urlInternet"] = undefined /*out*/;
            resourceInputs["urlIntranet"] = undefined /*out*/;
        }
