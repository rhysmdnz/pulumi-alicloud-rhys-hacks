...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `alicloud` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-alicloud
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-alicloud/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-alicloud_darwin_amd64_v1
│   └── pulumi-resource-alicloud
├── pulumi-alicloud_darwin_arm64
│   └── pulumi-resource-alicloud
├── pulumi-alicloud_linux_amd64_v1
│   └── pulumi-resource-alicloud
├── pulumi-alicloud_linux_arm64
│   └── pulumi-resource-alicloud
├── pulumi-alicloud_windows_amd64_v1
│   └── pulumi-resource-alicloud.exe
└── pulumi-alicloud_windows_arm64
    └── pulumi-resource-alicloud.exe
```
