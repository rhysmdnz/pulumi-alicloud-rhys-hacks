...
class GetGatewayVpnAttachmentsAttachmentResult(dict):
    def __init__(__self__, *,
        ...
        :param str internet_ip: The internet ip of the resource. The alicloud_cen_transit_router_vpn_attachment resource will not have a value until after it is created.
    ...
    def internet_ip(self) -> str:
        """
        The internet ip of the resource. The alicloud_cen_transit_router_vpn_attachment resource will not have a value until after it is created.
        """
...
class GetGatewayVpnAttachmentsAttachmentIkeConfigResult(dict):
    def __init__(__self__, *,
        ...
        :param str ike_version: The version of the IKE protocol.
        :param str local_id: The local ID, which supports the FQDN and IP formats. The current VPN gateway IP address is selected by default. The alicloud_cen_transit_router_vpn_attachment resource will not have a value until after it is created.
    ...
    def local_id(self) -> str:
        """
        The local ID, which supports the FQDN and IP formats. The current VPN gateway IP address is selected by default. The alicloud_cen_transit_router_vpn_attachment resource will not have a value until after it is created.
        """
        return pulumi.get(self, "local_id")
