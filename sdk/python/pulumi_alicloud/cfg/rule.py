...
class RuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, Any]] input_parameters: The settings of the input parameters for the rule.See the following `Block InputParameters`.
    ...
    def input_parameters(self) -> Optional[pulumi.Input[Mapping[str, Any]]]:
        """
        The settings of the input parameters for the rule.See the following `Block InputParameters`.
        """
