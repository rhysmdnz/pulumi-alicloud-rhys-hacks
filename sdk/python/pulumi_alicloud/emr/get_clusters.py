...
def get_clusters(cluster_name: Optional[str] = None,
    ...
    return AwaitableGetClustersResult(
        ...
        cluster_type_lists=__ret__.cluster_type_lists,
        clusters=__ret__.clusters,
        create_type=__ret__.create_type,
        default_status=__ret__.default_status,
        deposit_type=__ret__.deposit_type,
        enable_details=__ret__.enable_details,
        id=__ret__.id,
        ids=__ret__.ids,
        is_desc=__ret__.is_desc,
